function initSimulation() {
  ...
  var imagePaths = [
    ...
    "./assets/images/skills/OOP.svg",
    "./assets/images/skills/javascript.svg",
    // "./assets/images/skills/C#.svg",
    "./assets/images/skills/git.svg",
    "./assets/images/skills/github.svg",
    "./assets/images/skills/LINQ.svg",
    "./assets/images/skills/mysql.svg",
    "./assets/images/skills/canva.svg",
    "./assets/images/skills/Desgin Patterns.svg",
    "./assets/images/skills/EF Core.svg",
    "./assets/images/skills/sql.svg",
    "./assets/images/skills/MVC.svg",
    "./assets/images/skills/API.svg",
    // "./assets/images/skills/API.svg",
     "./assets/images/skills/cSharp.svg",
    "./assets/images/skills/Angular.svg",
    "./assets/images/skills/Solid Principles.svg",
    "./assets/images/skills/React.js.svg",
  ];
